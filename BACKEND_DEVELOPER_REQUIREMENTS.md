...
- Build Spring services following Manager/Service patterns for complex business logic
...
- Implement message queue processing for asynchronous bulk import operations
...
- Develop integration tests for Spring components using Spring Boot Test
...
- Deploy and configure Spring Boot application for local and production environments
- Package and deploy JAR artifacts using Gradle
- Configure data sources and application properties
...
- Implement automated build pipelines (Gradle + npm builds)
...
- **Spring Boot** expertise:
  ...
  - Spring Services (dependency injection and lifecycle management)
  - Spring Data JPA / Hibernate ORM (complex entity relationships, inheritance strategies)
...
- Experience configuring data sources and application properties
...
- Lead migration efforts (monolith → microservices)
