...
import { END_CUSTOMERS_WORKLIST_COLUMNS } from '../data/end-customers-worklist-columns.consts';
...
export const endCustomersWorklistFeatureKey = 'endCustomersWorklist';

export interface CustomersMeta {
  exampleTotal: number;
}
export interface EndCustomersWorklistState {
  filters: {
    search: string;
    offset: number;
    limit: number;
...
export const initialState: EndCustomersWorklistState = {
  filters: {
    search: '',
  ...
  columns: END_CUSTOMERS_WORKLIST_COLUMNS,
  updatedItem: {},
  selectedItems: [],
...
export const endCustomersWorklistReducer = createReducer(
  initialState,
