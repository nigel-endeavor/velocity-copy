...
@Component({
  selector: 'app-service-technical-ransomMDR',
  templateUrl: './service-technical-ransomMDR.component.html',
  styleUrls: ['../../../form-styles.scss']
})

export class ServiceTechnicalRansomMDRComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    this.store.pipe(select(getFlagByName('editingRansomMDRDetails'))).subscribe(res => {
      this.editingRansomMDRDetails = res;
    });
  ...
  setService(service: RansomMDRService): void {
