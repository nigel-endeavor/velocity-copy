...
@Component({
  selector: 'app-service-technical-engineering-MDM',
  templateUrl: './service-technical-engineering-MDM.component.html',
  styleUrls: ['../../../form-styles.scss']
})

export class ServiceTechnicalEngineeringMDMComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    this.store.pipe(select(getFlagByName('editingEngineeringMDMDetails'))).subscribe(res => {
      this.editingEngineeringMDMDetails = res;
    });
  ...
  setService(service: EngineeringMDMService): void {
