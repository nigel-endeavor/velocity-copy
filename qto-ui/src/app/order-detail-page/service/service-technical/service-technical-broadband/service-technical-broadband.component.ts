...
export const CIDR_SUBNET_MAPPING = new Map([
  ['/31', '255.255.255.254'],
  ['/30', '255.255.255.252'],
  ['/29', '255.255.255.248'],
  ['/28', '255.255.255.240'],
...
@Component({
  selector: 'app-service-technical-broadband',
  templateUrl: './service-technical-broadband.component.html',
  styleUrls: ['../../../form-styles.scss']
})
export class ServiceTechnicalBroadbandComponent implements OnInit, OnDestroy {
  ...
  @Input() service: BroadbandService;
  ...
  setService(service: BroadbandService): void {
  ...
  onNetworkProtocolChanged(value: string): void {
    // clear related fields
    // PPPoE
    this.service.pppoeUsername = this.service.pppoePassword = '';
    // Static
    this.service.ipFormat = this.service.additionalIpBlock = this.service.wanIps
      = this.service.wanGateway = this.service.wanSubnet = this.service.lanBlock = this.service.lanIps
      = this.service.lanSubnet = this.service.lanGateway = this.service.dns1 = this.service.dns2 = '';
      this.service.networkProtocol = value;
  }
