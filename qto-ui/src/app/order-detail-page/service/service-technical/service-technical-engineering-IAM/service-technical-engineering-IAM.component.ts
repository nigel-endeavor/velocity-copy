...
@Component({
  selector: 'app-service-technical-engineering-IAM',
  templateUrl: './service-technical-engineering-IAM.component.html',
  styleUrls: ['../../../form-styles.scss']
})

export class ServiceTechnicalEngineeringIAMComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    this.store.pipe(select(getFlagByName('editingEngineeringIAMDetails'))).subscribe(res => {
      this.editingEngineeringIAMDetails = res;
    });
  ...
  setService(service: EngineeringIAMService): void {
