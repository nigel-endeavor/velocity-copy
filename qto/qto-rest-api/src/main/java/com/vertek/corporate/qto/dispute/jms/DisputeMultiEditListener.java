...
import static com.vertek.corporate.qto.dispute.multiedit.DisputeMultiEditQueueHandler.DISPUTE_MULTI_EDIT_QUEUE;
...
@MessageDriven(activationConfig = {
        ...
        @ActivationConfigProperty(propertyName = "destination", propertyValue = DISPUTE_MULTI_EDIT_QUEUE),
        @ActivationConfigProperty(propertyName = "acknowledgeMode", propertyValue = "Auto-acknowledge"),
        @ActivationConfigProperty(propertyName = "maxSession", propertyValue = "1")
})
public class DisputeMultiEditListener implements MessageListener {
