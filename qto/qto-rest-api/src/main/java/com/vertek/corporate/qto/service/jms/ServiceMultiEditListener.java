...
import static com.vertek.corporate.qto.service.multiedit.ServiceMultiEditQueueHandler.SERVICE_MULTI_EDIT_QUEUE;
...
@MessageDriven(activationConfig = {
        ...
        @ActivationConfigProperty(propertyName = "destination", propertyValue = SERVICE_MULTI_EDIT_QUEUE),
        @ActivationConfigProperty(propertyName = "acknowledgeMode", propertyValue = "Auto-acknowledge"),
        @ActivationConfigProperty(propertyName = "maxSession", propertyValue = "1")
})
public class ServiceMultiEditListener implements MessageListener {
