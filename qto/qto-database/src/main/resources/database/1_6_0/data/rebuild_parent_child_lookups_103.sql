...
VALUES ((SELECT lookup_type_id FROM lookup_type WHERE lookup_type_code = 'ACTIVATION_ISSUE_PRIMARY'), 'Customer', 'Customer', 10, 1, (Select tenant_id from v_tenant t where t.name = 'Demo Tenant')),
       ((SELECT lookup_type_id FROM lookup_type WHERE lookup_type_code = 'ACTIVATION_ISSUE_PRIMARY'), 'Equipment', 'Equipment', 20, 1, (Select tenant_id from v_tenant t where t.name = 'Demo Tenant')),
       ((SELECT lookup_type_id FROM lookup_type WHERE lookup_type_code = 'ACTIVATION_ISSUE_PRIMARY'), 'Carrier', 'Carrier', 30, 1, (Select tenant_id from v_tenant t where t.name = 'Demo Tenant')),
       ((SELECT lookup_type_id FROM lookup_type WHERE lookup_type_code = 'ACTIVATION_ISSUE_PRIMARY'), 'Systems', 'Systems', 40, 1, (Select tenant_id from v_tenant t where t.name = 'Demo Tenant')),
       ((SELECT lookup_type_id FROM lookup_type WHERE lookup_type_code = 'ACTIVATION_ISSUE_PRIMARY'), 'Tech', 'Tech', 50, 1, (Select tenant_id from v_tenant t where t.name = 'Demo Tenant'));
...
# Secondary - Equipment
                            ...
                            WHERE lookup_type_id = (select lookup_type_id from lookup_type where lookup_type_code = 'ACTIVATION_ISSUE_PRIMARY')
                              ...
                              AND tenant_id = (Select tenant_id from v_tenant t where t.name = 'Demo Tenant'));
