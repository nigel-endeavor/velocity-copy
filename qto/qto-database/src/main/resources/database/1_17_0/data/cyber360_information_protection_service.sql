...
(
    cyber360_information_protection_service_id    SERIAL
        PRIMARY KEY,
...
VALUES ((SELECT lookup_type_id FROM lookup_type WHERE lookup_type_code = 'ALL_SERVICE_TYPES'), 'cyber360-Information Protection', 'cyber360-Information Protection', 0, 1, 0);
