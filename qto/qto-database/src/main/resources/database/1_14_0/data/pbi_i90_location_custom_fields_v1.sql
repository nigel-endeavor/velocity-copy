...
from custom_field cf
	...
	left join location_custom_field_value lcfv on cfv.custom_field_value_id = lcfv.custom_field_value_id
	join location l on lcfv.location_id = l.location_id
group by l.location_id, l.tenant_id, l.current_inventory, cft.tab;
