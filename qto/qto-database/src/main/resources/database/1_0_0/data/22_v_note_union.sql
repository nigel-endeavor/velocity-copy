...
SELECT DISTINCT s.location_id, s.service_id, n.note_id, n.category, n.created_by, n.created_date, note, n.internal_only
FROM service s
...
UNION ALL
SELECT DISTINCT l.location_id, s.service_id, n.note_id, n.category, n.created_by, n.created_date, n.note, n.internal_only
