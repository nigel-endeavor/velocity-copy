...
SELECT o.order_id,
       l.location_id,
       company_name,
       (select display_name from platform.subject where subject_id = provisioner) as provisioner,
       (select display_name from platform.subject where subject_id = client_project_manager) as client_project_manager,
