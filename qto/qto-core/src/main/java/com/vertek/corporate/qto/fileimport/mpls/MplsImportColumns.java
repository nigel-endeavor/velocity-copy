package com.vertek.corporate.qto.fileimport.mpls;

import com.vertek.corporate.qto.fileimport.AbstractInventoryServiceImportColumns;

import java.util.ArrayList;

public class MplsImportColumns extends AbstractInventoryServiceImportColumns {
    ...
    static final String MPLS_ACCESS_SPEED = "MPLS Access Speed";
    static final String MPLS_PORT_SPEED = "MPLS Port Speed";
    ...
    static final String PORT_CIRCUIT_ID = "Port Circuit ID";
    static final String MPLS_TYPE = "MPLS Type";
    ...
    static final String ROUTING_PROTOCOL = "Routing Protocol";
    static final String CER_IPS = "CER IP's";
    static final String PER_IPS = "PER IP's";
    static final String VLAN_TAG_1 = "VLAN Tag 1";
    static final String VLAN_TAG_2 = "VLAN Tag 2";
    static final String VLAN_TAG_3 = "VLAN Tag 3";
    static final String VLAN_TAG_4 = "VLAN Tag 4";
    static final String OTHER_TECHNICAL_NOTES = "Other Technical Notes";
    ...
    static {
        ...
        COL_LIST.add(MPLS_ACCESS_SPEED);
        COL_LIST.add(MPLS_PORT_SPEED);
        ...
        COL_LIST.add(PORT_CIRCUIT_ID);
        COL_LIST.add(MPLS_TYPE);
        ...
        COL_LIST.add(ROUTING_PROTOCOL);
        COL_LIST.add(CER_IPS);
        COL_LIST.add(PER_IPS);
        COL_LIST.add(VLAN_TAG_1);
        COL_LIST.add(VLAN_TAG_2);
        COL_LIST.add(VLAN_TAG_3);
        COL_LIST.add(VLAN_TAG_4);
        COL_LIST.add(OTHER_TECHNICAL_NOTES);
