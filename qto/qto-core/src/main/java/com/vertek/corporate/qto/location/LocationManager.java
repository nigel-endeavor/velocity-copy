...
import com.vertek.corporate.qto.common.FlatMapUtil;
...
import com.vertek.corporate.qto.location.jms.LocationMessageHandler;
...
import com.vertek.corporate.qto.note.Note;
...
import static com.vertek.corporate.qto.common.SecurityUtils.getLoggedInUser;
...
public class LocationManager extends StandardManager<Location> {
    ...
    public Location edit(final Location entity) {
        ...
        if (TerminalLocationStatuses.getStatuses().contains(existing.getStatus())) {
            if (!SCHEDULER.equals(SecurityUtils.getLoggedInUser()) && org.apache.shiro.SecurityUtils.getSubject().isPermitted(Permissions.ORDER_WRITE_TERMINAL)) {
