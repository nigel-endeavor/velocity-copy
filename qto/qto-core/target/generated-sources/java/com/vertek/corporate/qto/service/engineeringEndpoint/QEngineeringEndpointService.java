...
/**
 * QEngineeringEndpointService is a Querydsl query type for EngineeringEndpointService
 */
@Generated("com.querydsl.codegen.DefaultEntitySerializer")
public class QEngineeringEndpointService extends EntityPathBase<EngineeringEndpointService> {

    private static final long serialVersionUID = 18277857L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QEngineeringEndpointService engineeringEndpointService = new QEngineeringEndpointService("engineeringEndpointService");
    ...
    public QEngineeringEndpointService(String variable) {
        this(EngineeringEndpointService.class, forVariable(variable), INITS);
    }

    public QEngineeringEndpointService(Path<? extends EngineeringEndpointService> path) {
        this(path.getType(), path.getMetadata(), PathInits.getFor(path.getMetadata(), INITS));
    }

    public QEngineeringEndpointService(PathMetadata metadata) {
        this(metadata, PathInits.getFor(metadata, INITS));
    }

    public QEngineeringEndpointService(PathMetadata metadata, PathInits inits) {
        this(EngineeringEndpointService.class, metadata, inits);
    }

    public QEngineeringEndpointService(Class<? extends EngineeringEndpointService> type, PathMetadata metadata, PathInits inits) {
