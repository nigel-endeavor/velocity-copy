...
/**
 * QUcaasService is a Querydsl query type for UcaasService
 */
@Generated("com.querydsl.codegen.DefaultEntitySerializer")
public class QUcaasService extends EntityPathBase<UcaasService> {

    private static final long serialVersionUID = -665603225L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QUcaasService ucaasService = new QUcaasService("ucaasService");
    ...
    public final NumberPath<Long> numberOfHandsets = createNumber("numberOfHandsets", Long.class);
    ...
    public final StringPath publishedTn = createString("publishedTn");
    ...
    public final StringPath temporaryTn = createString("temporaryTn");
    ...
    public QUcaasService(String variable) {
        this(UcaasService.class, forVariable(variable), INITS);
    }

    public QUcaasService(Path<? extends UcaasService> path) {
        this(path.getType(), path.getMetadata(), PathInits.getFor(path.getMetadata(), INITS));
    }

    public QUcaasService(PathMetadata metadata) {
        this(metadata, PathInits.getFor(metadata, INITS));
    }

    public QUcaasService(PathMetadata metadata, PathInits inits) {
        this(UcaasService.class, metadata, inits);
    }

    public QUcaasService(Class<? extends UcaasService> type, PathMetadata metadata, PathInits inits) {
