...
/**
 * QEthernetService is a Querydsl query type for EthernetService
 */
@Generated("com.querydsl.codegen.DefaultEntitySerializer")
public class QEthernetService extends EntityPathBase<EthernetService> {

    private static final long serialVersionUID = 579479349L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QEthernetService ethernetService = new QEthernetService("ethernetService");

    public final com.vertek.corporate.qto.service.QService _super;

    public final StringPath accessHours = createString("accessHours");

    public final StringPath accessSpeed = createString("accessSpeed");
    ...
    public final StringPath alternatePopClli = createString("alternatePopClli");
    ...
    public final StringPath cableCategory = createString("cableCategory");

    public final StringPath cableShielding = createString("cableShielding");

    public final StringPath cfa = createString("cfa");
    ...
    public final StringPath clliCode = createString("clliCode");
    ...
    public final StringPath dataCenterName = createString("dataCenterName");
    ...
    public final StringPath eaSpeed = createString("eaSpeed");
    ...
    public final StringPath handoffConnectorType = createString("handoffConnectorType");

    public final StringPath handoffFiberMode = createString("handoffFiberMode");
    ...
    public final StringPath interfaceConnector = createString("interfaceConnector");
    ...
    public final StringPath loaRequired = createString("loaRequired");
    ...
    public final StringPath manned = createString("manned");
    ...
    public final StringPath mtu = createString("mtu");

    public final StringPath mux = createString("mux");
    ...
    public final StringPath npaNxx = createString("npaNxx");
    ...
    public final StringPath popClli = createString("popClli");

    public final StringPath portSpeed = createString("portSpeed");
    ...
    public final StringPath vlanForEline = createString("vlanForEline");

    public final StringPath vlanId = createString("vlanId");

    public final StringPath vlanTagging = createString("vlanTagging");
    ...
    public final StringPath zAccessHours = createString("zAccessHours");

    public final StringPath zAccessType = createString("zAccessType");

    public final StringPath zAddress1 = createString("zAddress1");

    public final StringPath zAddress2 = createString("zAddress2");

    public final StringPath zAlternatePopClli = createString("zAlternatePopClli");

    public final StringPath zBuildingStatus = createString("zBuildingStatus");

    public final StringPath zCfa = createString("zCfa");

    public final StringPath zCity = createString("zCity");

    public final StringPath zClliCode = createString("zClliCode");

    public final StringPath zCountry = createString("zCountry");

    public final StringPath zDataCenterName = createString("zDataCenterName");

    public final StringPath zDmarc = createString("zDmarc");

    public final StringPath zFloor = createString("zFloor");

    public final StringPath zHandoffConnectorType = createString("zHandoffConnectorType");

    public final StringPath zHandoffFiberMode = createString("zHandoffFiberMode");

    public final StringPath zHandoffMediaType = createString("zHandoffMediaType");

    public final StringPath zInsideWiringRequired = createString("zInsideWiringRequired");

    public final StringPath zInterfaceConnector = createString("zInterfaceConnector");

    public final StringPath zLoaRequired = createString("zLoaRequired");

    public final StringPath zManned = createString("zManned");

    public final StringPath zNpaNxx = createString("zNpaNxx");

    public final StringPath zPopClli = createString("zPopClli");

    public final StringPath zPostalCode = createString("zPostalCode");

    public final StringPath zProviderCircuitId = createString("zProviderCircuitId");

    public final StringPath zState = createString("zState");

    public QEthernetService(String variable) {
        this(EthernetService.class, forVariable(variable), INITS);
    }

    public QEthernetService(Path<? extends EthernetService> path) {
        this(path.getType(), path.getMetadata(), PathInits.getFor(path.getMetadata(), INITS));
    }

    public QEthernetService(PathMetadata metadata) {
        this(metadata, PathInits.getFor(metadata, INITS));
    }

    public QEthernetService(PathMetadata metadata, PathInits inits) {
        this(EthernetService.class, metadata, inits);
    }

    public QEthernetService(Class<? extends EthernetService> type, PathMetadata metadata, PathInits inits) {
