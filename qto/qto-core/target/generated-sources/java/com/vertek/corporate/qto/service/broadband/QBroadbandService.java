...
/**
 * QBroadbandService is a Querydsl query type for BroadbandService
 */
@Generated("com.querydsl.codegen.DefaultEntitySerializer")
public class QBroadbandService extends EntityPathBase<BroadbandService> {

    private static final long serialVersionUID = 610950531L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QBroadbandService broadbandService = new QBroadbandService("broadbandService");
    ...
    public final StringPath customerPremEquipment = createString("customerPremEquipment");
    ...
    public final StringPath modemMake = createString("modemMake");
    ...
    public final StringPath networkProtocol = createString("networkProtocol");
    ...
    public final StringPath pppoePassword = createString("pppoePassword");

    public final StringPath pppoeUsername = createString("pppoeUsername");
    ...
    public QBroadbandService(String variable) {
        this(BroadbandService.class, forVariable(variable), INITS);
    }

    public QBroadbandService(Path<? extends BroadbandService> path) {
        this(path.getType(), path.getMetadata(), PathInits.getFor(path.getMetadata(), INITS));
    }

    public QBroadbandService(PathMetadata metadata) {
        this(metadata, PathInits.getFor(metadata, INITS));
    }

    public QBroadbandService(PathMetadata metadata, PathInits inits) {
        this(BroadbandService.class, metadata, inits);
    }

    public QBroadbandService(Class<? extends BroadbandService> type, PathMetadata metadata, PathInits inits) {
