...
/**
 * QEngineeringInfoProtectionService is a Querydsl query type for EngineeringInfoProtectionService
 */
@Generated("com.querydsl.codegen.DefaultEntitySerializer")
public class QEngineeringInfoProtectionService extends EntityPathBase<EngineeringInfoProtectionService> {

    private static final long serialVersionUID = 225493437L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QEngineeringInfoProtectionService engineeringInfoProtectionService = new QEngineeringInfoProtectionService("engineeringInfoProtectionService");
    ...
    public QEngineeringInfoProtectionService(String variable) {
        this(EngineeringInfoProtectionService.class, forVariable(variable), INITS);
    }

    public QEngineeringInfoProtectionService(Path<? extends EngineeringInfoProtectionService> path) {
        this(path.getType(), path.getMetadata(), PathInits.getFor(path.getMetadata(), INITS));
    }

    public QEngineeringInfoProtectionService(PathMetadata metadata) {
        this(metadata, PathInits.getFor(metadata, INITS));
    }

    public QEngineeringInfoProtectionService(PathMetadata metadata, PathInits inits) {
        this(EngineeringInfoProtectionService.class, metadata, inits);
    }

    public QEngineeringInfoProtectionService(Class<? extends EngineeringInfoProtectionService> type, PathMetadata metadata, PathInits inits) {
