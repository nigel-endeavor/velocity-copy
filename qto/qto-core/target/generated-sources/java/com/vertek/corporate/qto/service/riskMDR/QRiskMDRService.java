...
/**
 * QRiskMDRService is a Querydsl query type for RiskMDRService
 */
@Generated("com.querydsl.codegen.DefaultEntitySerializer")
public class QRiskMDRService extends EntityPathBase<RiskMDRService> {

    private static final long serialVersionUID = 1644844697L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QRiskMDRService riskMDRService = new QRiskMDRService("riskMDRService");
    ...
    public final StringPath ipTechnicalNotes = createString("ipTechnicalNotes");
    ...
    public final StringPath numberOfAssets = createString("numberOfAssets");

    //inherited
    public final NumberPath<Integer> numberOfEndpoints;

    public final StringPath numberOfIPs = createString("numberOfIPs");
    ...
    public QRiskMDRService(String variable) {
        this(RiskMDRService.class, forVariable(variable), INITS);
    }

    public QRiskMDRService(Path<? extends RiskMDRService> path) {
        this(path.getType(), path.getMetadata(), PathInits.getFor(path.getMetadata(), INITS));
    }

    public QRiskMDRService(PathMetadata metadata) {
        this(metadata, PathInits.getFor(metadata, INITS));
    }

    public QRiskMDRService(PathMetadata metadata, PathInits inits) {
        this(RiskMDRService.class, metadata, inits);
    }

    public QRiskMDRService(Class<? extends RiskMDRService> type, PathMetadata metadata, PathInits inits) {
