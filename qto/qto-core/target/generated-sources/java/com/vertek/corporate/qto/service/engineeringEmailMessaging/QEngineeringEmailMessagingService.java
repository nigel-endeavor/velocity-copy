...
/**
 * QEngineeringEmailMessagingService is a Querydsl query type for EngineeringEmailMessagingService
 */
@Generated("com.querydsl.codegen.DefaultEntitySerializer")
public class QEngineeringEmailMessagingService extends EntityPathBase<EngineeringEmailMessagingService> {

    private static final long serialVersionUID = 1472024955L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QEngineeringEmailMessagingService engineeringEmailMessagingService = new QEngineeringEmailMessagingService("engineeringEmailMessagingService");
    ...
    public QEngineeringEmailMessagingService(String variable) {
        this(EngineeringEmailMessagingService.class, forVariable(variable), INITS);
    }

    public QEngineeringEmailMessagingService(Path<? extends EngineeringEmailMessagingService> path) {
        this(path.getType(), path.getMetadata(), PathInits.getFor(path.getMetadata(), INITS));
    }

    public QEngineeringEmailMessagingService(PathMetadata metadata) {
        this(metadata, PathInits.getFor(metadata, INITS));
    }

    public QEngineeringEmailMessagingService(PathMetadata metadata, PathInits inits) {
        this(EngineeringEmailMessagingService.class, metadata, inits);
    }

    public QEngineeringEmailMessagingService(Class<? extends EngineeringEmailMessagingService> type, PathMetadata metadata, PathInits inits) {
