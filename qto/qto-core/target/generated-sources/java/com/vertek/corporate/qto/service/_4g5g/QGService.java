...
/**
 * QGService is a Querydsl query type for GService
 */
@Generated("com.querydsl.codegen.DefaultEntitySerializer")
public class QGService extends EntityPathBase<GService> {

    private static final long serialVersionUID = -961241210L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QGService gService = new QGService("gService");
    ...
    public final StringPath apn = createString("apn");
    ...
    public final StringPath circuitPriority = createString("circuitPriority");
    ...
    public final StringPath ratePlan = createString("ratePlan");
    ...
    public final NumberPath<java.math.BigDecimal> rsrp = createNumber("rsrp", java.math.BigDecimal.class);

    public final NumberPath<java.math.BigDecimal> rsrq = createNumber("rsrq", java.math.BigDecimal.class);

    public final NumberPath<java.math.BigDecimal> rssi = createNumber("rssi", java.math.BigDecimal.class);
    ...
    public final NumberPath<java.math.BigDecimal> sinr = createNumber("sinr", java.math.BigDecimal.class);
    ...
    public QGService(String variable) {
        this(GService.class, forVariable(variable), INITS);
    }

    public QGService(Path<? extends GService> path) {
        this(path.getType(), path.getMetadata(), PathInits.getFor(path.getMetadata(), INITS));
    }

    public QGService(PathMetadata metadata) {
        this(metadata, PathInits.getFor(metadata, INITS));
    }

    public QGService(PathMetadata metadata, PathInits inits) {
        this(GService.class, metadata, inits);
    }

    public QGService(Class<? extends GService> type, PathMetadata metadata, PathInits inits) {
