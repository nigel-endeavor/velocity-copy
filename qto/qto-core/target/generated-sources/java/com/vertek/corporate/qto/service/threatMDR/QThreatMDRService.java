...
/**
 * QThreatMDRService is a Querydsl query type for ThreatMDRService
 */
@Generated("com.querydsl.codegen.DefaultEntitySerializer")
public class QThreatMDRService extends EntityPathBase<ThreatMDRService> {

    private static final long serialVersionUID = 1115160687L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QThreatMDRService threatMDRService = new QThreatMDRService("threatMDRService");
    ...
    public final StringPath hotStorageRetention = createString("hotStorageRetention");
    ...
    public final StringPath logRetentionRequirement = createString("logRetentionRequirement");
    ...
    public final NumberPath<Integer> sensors = createNumber("sensors", Integer.class);
    ...
    public final StringPath tierExpansionStorageSize = createString("tierExpansionStorageSize");
    ...
    public final StringPath usmAnywhereControlNode = createString("usmAnywhereControlNode");
    ...
    public QThreatMDRService(String variable) {
        this(ThreatMDRService.class, forVariable(variable), INITS);
    }

    public QThreatMDRService(Path<? extends ThreatMDRService> path) {
        this(path.getType(), path.getMetadata(), PathInits.getFor(path.getMetadata(), INITS));
    }

    public QThreatMDRService(PathMetadata metadata) {
        this(metadata, PathInits.getFor(metadata, INITS));
    }

    public QThreatMDRService(PathMetadata metadata, PathInits inits) {
        this(ThreatMDRService.class, metadata, inits);
    }

    public QThreatMDRService(Class<? extends ThreatMDRService> type, PathMetadata metadata, PathInits inits) {
