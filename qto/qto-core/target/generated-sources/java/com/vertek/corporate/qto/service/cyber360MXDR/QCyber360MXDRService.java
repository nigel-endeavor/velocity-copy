...
/**
 * QCyber360MXDRService is a Querydsl query type for Cyber360MXDRService
 */
@Generated("com.querydsl.codegen.DefaultEntitySerializer")
public class QCyber360MXDRService extends EntityPathBase<Cyber360MXDRService> {

    private static final long serialVersionUID = 977234165L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QCyber360MXDRService cyber360MXDRService = new QCyber360MXDRService("cyber360MXDRService");
    ...
    public final StringPath numberOfEndpointsDevices = createString("numberOfEndpointsDevices");
    ...
    public QCyber360MXDRService(String variable) {
        this(Cyber360MXDRService.class, forVariable(variable), INITS);
    }

    public QCyber360MXDRService(Path<? extends Cyber360MXDRService> path) {
        this(path.getType(), path.getMetadata(), PathInits.getFor(path.getMetadata(), INITS));
    }

    public QCyber360MXDRService(PathMetadata metadata) {
        this(metadata, PathInits.getFor(metadata, INITS));
    }

    public QCyber360MXDRService(PathMetadata metadata, PathInits inits) {
        this(Cyber360MXDRService.class, metadata, inits);
    }

    public QCyber360MXDRService(Class<? extends Cyber360MXDRService> type, PathMetadata metadata, PathInits inits) {
