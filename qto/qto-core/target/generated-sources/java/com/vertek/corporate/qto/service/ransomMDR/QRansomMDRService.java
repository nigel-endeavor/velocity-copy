...
/**
 * QRansomMDRService is a Querydsl query type for RansomMDRService
 */
@Generated("com.querydsl.codegen.DefaultEntitySerializer")
public class QRansomMDRService extends EntityPathBase<RansomMDRService> {

    private static final long serialVersionUID = 1749720159L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QRansomMDRService ransomMDRService = new QRansomMDRService("ransomMDRService");
    ...
    public final StringPath agentDeployment = createString("agentDeployment");
    ...
    public QRansomMDRService(String variable) {
        this(RansomMDRService.class, forVariable(variable), INITS);
    }

    public QRansomMDRService(Path<? extends RansomMDRService> path) {
        this(path.getType(), path.getMetadata(), PathInits.getFor(path.getMetadata(), INITS));
    }

    public QRansomMDRService(PathMetadata metadata) {
        this(metadata, PathInits.getFor(metadata, INITS));
    }

    public QRansomMDRService(PathMetadata metadata, PathInits inits) {
        this(RansomMDRService.class, metadata, inits);
    }

    public QRansomMDRService(Class<? extends RansomMDRService> type, PathMetadata metadata, PathInits inits) {
