...
/**
 * QTelevisionService is a Querydsl query type for TelevisionService
 */
@Generated("com.querydsl.codegen.DefaultEntitySerializer")
public class QTelevisionService extends EntityPathBase<TelevisionService> {

    private static final long serialVersionUID = 528957653L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QTelevisionService televisionService = new QTelevisionService("televisionService");
    ...
    public final StringPath dvr = createString("dvr");

    public final BooleanPath dvrIncluded = createBoolean("dvrIncluded");

    public final StringPath dvrMac = createString("dvrMac");
    ...
    public final StringPath receiverMac = createString("receiverMac");
    ...
    public QTelevisionService(String variable) {
        this(TelevisionService.class, forVariable(variable), INITS);
    }

    public QTelevisionService(Path<? extends TelevisionService> path) {
        this(path.getType(), path.getMetadata(), PathInits.getFor(path.getMetadata(), INITS));
    }

    public QTelevisionService(PathMetadata metadata) {
        this(metadata, PathInits.getFor(metadata, INITS));
    }

    public QTelevisionService(PathMetadata metadata, PathInits inits) {
        this(TelevisionService.class, metadata, inits);
    }

    public QTelevisionService(Class<? extends TelevisionService> type, PathMetadata metadata, PathInits inits) {
