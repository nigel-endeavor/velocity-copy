...
/**
 * QEngineeringIAMService is a Querydsl query type for EngineeringIAMService
 */
@Generated("com.querydsl.codegen.DefaultEntitySerializer")
public class QEngineeringIAMService extends EntityPathBase<EngineeringIAMService> {

    private static final long serialVersionUID = -158624043L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QEngineeringIAMService engineeringIAMService = new QEngineeringIAMService("engineeringIAMService");
    ...
    public QEngineeringIAMService(String variable) {
        this(EngineeringIAMService.class, forVariable(variable), INITS);
    }

    public QEngineeringIAMService(Path<? extends EngineeringIAMService> path) {
        this(path.getType(), path.getMetadata(), PathInits.getFor(path.getMetadata(), INITS));
    }

    public QEngineeringIAMService(PathMetadata metadata) {
        this(metadata, PathInits.getFor(metadata, INITS));
    }

    public QEngineeringIAMService(PathMetadata metadata, PathInits inits) {
        this(EngineeringIAMService.class, metadata, inits);
    }

    public QEngineeringIAMService(Class<? extends EngineeringIAMService> type, PathMetadata metadata, PathInits inits) {
