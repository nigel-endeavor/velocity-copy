...
/**
 * QMplsService is a Querydsl query type for MplsService
 */
@Generated("com.querydsl.codegen.DefaultEntitySerializer")
public class QMplsService extends EntityPathBase<MplsService> {

    private static final long serialVersionUID = -1811111467L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QMplsService mplsService = new QMplsService("mplsService");

    public final com.vertek.corporate.qto.service.QService _super;

    public final StringPath accessCircuitId = createString("accessCircuitId");
    ...
    public final StringPath cerIps = createString("cerIps");
    ...
    public final StringPath lastMileProvider = createString("lastMileProvider");
    ...
    public final StringPath mplsType = createString("mplsType");
    ...
    public final StringPath otherTechnicalNotes = createString("otherTechnicalNotes");
    ...
    public final StringPath perIps = createString("perIps");

    //inherited
    public final StringPath poNumber;

    public final StringPath portCircuitId = createString("portCircuitId");
    ...
    public final StringPath providerActivationMethod = createString("providerActivationMethod");
    ...
    public final StringPath routingProtocol = createString("routingProtocol");
    ...
    public final StringPath vlanTag1 = createString("vlanTag1");

    public final StringPath vlanTag2 = createString("vlanTag2");

    public final StringPath vlanTag3 = createString("vlanTag3");

    public final StringPath vlanTag4 = createString("vlanTag4");
    ...
    public QMplsService(String variable) {
        this(MplsService.class, forVariable(variable), INITS);
    }

    public QMplsService(Path<? extends MplsService> path) {
        this(path.getType(), path.getMetadata(), PathInits.getFor(path.getMetadata(), INITS));
    }

    public QMplsService(PathMetadata metadata) {
        this(metadata, PathInits.getFor(metadata, INITS));
    }

    public QMplsService(PathMetadata metadata, PathInits inits) {
        this(MplsService.class, metadata, inits);
    }

    public QMplsService(Class<? extends MplsService> type, PathMetadata metadata, PathInits inits) {
