...
/**
 * QEngineeringMDMService is a Querydsl query type for EngineeringMDMService
 */
@Generated("com.querydsl.codegen.DefaultEntitySerializer")
public class QEngineeringMDMService extends EntityPathBase<EngineeringMDMService> {

    private static final long serialVersionUID = -1991997195L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QEngineeringMDMService engineeringMDMService = new QEngineeringMDMService("engineeringMDMService");
    ...
    public QEngineeringMDMService(String variable) {
        this(EngineeringMDMService.class, forVariable(variable), INITS);
    }

    public QEngineeringMDMService(Path<? extends EngineeringMDMService> path) {
        this(path.getType(), path.getMetadata(), PathInits.getFor(path.getMetadata(), INITS));
    }

    public QEngineeringMDMService(PathMetadata metadata) {
        this(metadata, PathInits.getFor(metadata, INITS));
    }

    public QEngineeringMDMService(PathMetadata metadata, PathInits inits) {
        this(EngineeringMDMService.class, metadata, inits);
    }

    public QEngineeringMDMService(Class<? extends EngineeringMDMService> type, PathMetadata metadata, PathInits inits) {
