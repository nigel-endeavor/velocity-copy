...
/**
 * QLocationFileAttachment is a Querydsl query type for LocationFileAttachment
 */
@Generated("com.querydsl.codegen.DefaultEntitySerializer")
public class QLocationFileAttachment extends EntityPathBase<LocationFileAttachment> {

    private static final long serialVersionUID = -1517739190L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QLocationFileAttachment locationFileAttachment = new QLocationFileAttachment("locationFileAttachment");
    ...
    public QLocationFileAttachment(String variable) {
        this(LocationFileAttachment.class, forVariable(variable), INITS);
    }

    public QLocationFileAttachment(Path<? extends LocationFileAttachment> path) {
        this(path.getType(), path.getMetadata(), PathInits.getFor(path.getMetadata(), INITS));
    }

    public QLocationFileAttachment(PathMetadata metadata) {
        this(metadata, PathInits.getFor(metadata, INITS));
    }

    public QLocationFileAttachment(PathMetadata metadata, PathInits inits) {
        this(LocationFileAttachment.class, metadata, inits);
    }

    public QLocationFileAttachment(Class<? extends LocationFileAttachment> type, PathMetadata metadata, PathInits inits) {
