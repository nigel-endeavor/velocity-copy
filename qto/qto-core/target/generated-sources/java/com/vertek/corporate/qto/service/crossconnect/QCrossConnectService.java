...
/**
 * QCrossConnectService is a Querydsl query type for CrossConnectService
 */
@Generated("com.querydsl.codegen.DefaultEntitySerializer")
public class QCrossConnectService extends EntityPathBase<CrossConnectService> {

    private static final long serialVersionUID = 524865013L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QCrossConnectService crossConnectService = new QCrossConnectService("crossConnectService");
    ...
    public final StringPath crossConnectDataCenterName = createString("crossConnectDataCenterName");

    public final StringPath crossConnectId = createString("crossConnectId");

    public final StringPath crossConnectPort = createString("crossConnectPort");

    public final StringPath crossConnectRack = createString("crossConnectRack");

    public final StringPath crossConnectRoom = createString("crossConnectRoom");

    public final StringPath crossConnectType = createString("crossConnectType");
    ...
    public QCrossConnectService(String variable) {
        this(CrossConnectService.class, forVariable(variable), INITS);
    }

    public QCrossConnectService(Path<? extends CrossConnectService> path) {
        this(path.getType(), path.getMetadata(), PathInits.getFor(path.getMetadata(), INITS));
    }

    public QCrossConnectService(PathMetadata metadata) {
        this(metadata, PathInits.getFor(metadata, INITS));
    }

    public QCrossConnectService(PathMetadata metadata, PathInits inits) {
        this(CrossConnectService.class, metadata, inits);
    }

    public QCrossConnectService(Class<? extends CrossConnectService> type, PathMetadata metadata, PathInits inits) {
