...
/**
 * QDiaService is a Querydsl query type for DiaService
 */
@Generated("com.querydsl.codegen.DefaultEntitySerializer")
public class QDiaService extends EntityPathBase<DiaService> {

    private static final long serialVersionUID = -1554460295L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QDiaService diaService = new QDiaService("diaService");
    ...
    public final StringPath burstableSpeed = createString("burstableSpeed");

    public final NumberPath<java.math.BigDecimal> burstableSpeedCost = createNumber("burstableSpeedCost", java.math.BigDecimal.class);
    ...
    public final StringPath newAccessCircuitId = createString("newAccessCircuitId");
    ...
    public final StringPath routerMacAddress = createString("routerMacAddress");
    ...
    public QDiaService(String variable) {
        this(DiaService.class, forVariable(variable), INITS);
    }

    public QDiaService(Path<? extends DiaService> path) {
        this(path.getType(), path.getMetadata(), PathInits.getFor(path.getMetadata(), INITS));
    }

    public QDiaService(PathMetadata metadata) {
        this(metadata, PathInits.getFor(metadata, INITS));
    }

    public QDiaService(PathMetadata metadata, PathInits inits) {
        this(DiaService.class, metadata, inits);
    }

    public QDiaService(Class<? extends DiaService> type, PathMetadata metadata, PathInits inits) {
