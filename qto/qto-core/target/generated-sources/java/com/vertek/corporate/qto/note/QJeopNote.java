...
/**
 * QJeopNote is a Querydsl query type for JeopNote
 */
@Generated("com.querydsl.codegen.DefaultEntitySerializer")
public class QJeopNote extends EntityPathBase<JeopNote> {

    private static final long serialVersionUID = -1830888523L;

    public static final QJeopNote jeopNote = new QJeopNote("jeopNote");
    ...
    public QJeopNote(String variable) {
        super(JeopNote.class, forVariable(variable));
    }

    public QJeopNote(Path<? extends JeopNote> path) {
        super(path.getType(), path.getMetadata());
    }

    public QJeopNote(PathMetadata metadata) {
        super(JeopNote.class, metadata);
    }
